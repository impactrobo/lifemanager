...
const TRIGGER_SELECTOR =
  '.btn-primary, .btn-danger, .btn-good, .subnav button.active, .workout-cell.home-tile';
...
interface Ember {
  ...
  /** ms remaining */
  life: number;
  /** ms at spawn, for normalised fade/shrink */
  maxLife: number;
  size: number;
  /** per-ember flicker phase so they don't pulse in lockstep */
  phase: number;
}
...
function createDraconicFX(): AestheticFX {
