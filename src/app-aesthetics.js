...
const ICONS = {
  // The bathroom sheet on BODY. A cistern, a seat and a pedestal, drawn plainly — this one names a
  // screen full of Bristol swatches, so a coy glyph would be less clear, not more tactful.
  toilet: `<svg class="icon-svg" viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true"><rect x="4" y="3" width="5.5" height="6.5" rx="1" fill="var(--accent)" fill-opacity=".16" stroke="var(--accent)" stroke-width="1.6"/><path d="M4 10h15v1a6 6 0 0 1-6 6h-3a6 6 0 0 1-6-6z" fill="var(--accent)" fill-opacity=".16" stroke="var(--accent)" stroke-width="1.6" stroke-linejoin="round"/><path d="M10.5 17v3" stroke="var(--accent)" stroke-width="1.6" stroke-linecap="round"/><path d="M7.5 20.5h6" stroke="var(--accent)" stroke-width="1.8" stroke-linecap="round"/></svg>`,
  ...
  // The `exercise` barbell, scaled to 0.6 and re-centred at (12, 11) so it sits inside the heart's
  // rounder upper body rather than its narrowing lower point -- the Home tile for the merged
  // Health & Wellness section. Health & Diet's `health` icon (above) stays defined and unused by
  // any tile, same as its HOME_SECTION_META entry: link chips still read its colour.
  wellness: `<svg class="icon-svg" viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true"><path d="M12 20s-7.5-4.7-9.8-9.4C.7 6.9 3 3.6 6.4 3.6c2 0 3.5 1 5.6 3.1 2.1-2.1 3.6-3.1 5.6-3.1 3.4 0 5.7 3.3 4.2 7-2.3 4.7-9.8 9.4-9.8 9.4z" fill="var(--accent)" fill-opacity=".18" stroke="var(--accent)" stroke-width="1.6" stroke-linejoin="round"/><rect x="6.18" y="10.4" width="1.8" height="2.4" rx="0.48" fill="var(--accent)" fill-opacity=".35"/><rect x="16.02" y="10.4" width="1.8" height="2.4" rx="0.48" fill="var(--accent)" fill-opacity=".35"/><rect x="7.8" y="9.5" width="1.2" height="4.2" rx="0.36" fill="var(--accent)"/><rect x="15" y="9.5" width="1.2" height="4.2" rx="0.36" fill="var(--accent)"/><path d="M9 11h6" stroke="var(--accent)" stroke-width="1.1" stroke-linecap="round"/></svg>`,
