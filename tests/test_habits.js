...
(async () => {
  ...
  await settle(page);
  // A break is irreversible, so it is gated behind two confirmations — the first asks whether you
  // mean it, the second says plainly that it can't be undone. One click now writes nothing.
